            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  {adminData ? "Update administrative details" : "Record a new admin account"}
                </p>
              </div>
            </div>
            <button
          ...
          <div className="flex items-start gap-2 p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
            ...
            <div className="flex-1 min-w-0">
              ...
              <input
                ...
                className="w-full text-xs bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 focus:border-amber-500 dark:focus:border-amber-400 outline-none py-0.5 text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                disabled={isLocked}
              />
            </div>
          </div>
